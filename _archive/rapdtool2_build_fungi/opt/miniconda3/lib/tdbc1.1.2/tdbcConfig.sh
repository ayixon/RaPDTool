...
# dir.
tdbc_LIB_SPEC="-L/opt/miniconda3/lib/tdbc1.1.2 -ltdbc1.1.2"
TDBC_LIB_SPEC="-L/opt/miniconda3/lib/tdbc1.1.2 -ltdbc1.1.2"
...
# String to pass to the linker to pick up the TDBC stub library from its
# installed directory
tdbc_STUB_LIB_SPEC="-L/opt/miniconda3/lib/tdbc1.1.2 -ltdbcstub1.1.2"
TDBC_STUB_LIB_SPEC="-L/opt/miniconda3/lib/tdbc1.1.2 -ltdbcstub1.1.2"
...
tdbc_STUB_LIB_PATH="/opt/miniconda3/lib/tdbc1.1.2/libtdbcstub1.1.2.a"
TDBC_STUB_LIB_PATH="/opt/miniconda3/lib/tdbc1.1.2/libtdbcstub1.1.2.a"
...
# headers
tdbc_INCLUDE_SPEC="-I/opt/miniconda3/include"
TDBC_INCLUDE_SPEC="-I/opt/miniconda3/include"
...
tdbc_LIBRARY_PATH="/opt/miniconda3/lib/tdbc1.1.2"
TDBC_LIBRARY_PATH="/opt/miniconda3/lib/tdbc1.1.2"
