...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/opt/miniconda3/bin',
 'BINLIBDEST': '/opt/miniconda3/lib/python3.9',
 'BLDLIBRARY': 'libpython3.9.a',
 'BLDSHARED': ''
              'gcc -pthread -B /opt/miniconda3/compiler_compat -shared  '
              ''
              ''
              '-Wl,-rpath,/opt/miniconda3/lib '
              '-Wl,-rpath-link,/opt/miniconda3/lib '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': ''
       'gcc -pthread -B /opt/miniconda3/compiler_compat',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_LDFLAGS_NODIST': ''
                             ' -g',
 'CONFIG_ARGS': "'--prefix=/opt/miniconda3' "
                "'--build=x86_64-conda_cos6-linux-gnu' "
                "'--host=x86_64-conda_cos6-linux-gnu''--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/opt/miniconda3/share/zoneinfo:/opt/miniconda3/share/tzinfo' "
                "'--with-computed-gotos''--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/opt/miniconda3/include' "
                "'--with-tcltk-libs=-L/opt/miniconda3/lib "
                "-ltcl8.6 -ltk8.6''--with-platlibdir=lib' "
                "'--with-openssl=/opt/miniconda3' "
                "'PKG_CONFIG_LIBDIR=/opt/miniconda3/lib' "
                "'PKG_CONFIG_PATH=/opt/miniconda3/lib' "
 ...
 'CONFINCLUDEDIR': '/opt/miniconda3/include',
 'CONFINCLUDEPY': '/opt/miniconda3/include/python3.9',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             ...
             '/opt/miniconda3/include '
             '-I/opt/miniconda3/include',
 'CXX': 'g++ -pthread -B /opt/miniconda3/compiler_compat',
 'DESTDIRS': '/opt/miniconda3 '
             '/opt/miniconda3/lib '
             '/opt/miniconda3/lib/python3.9 '
             '/opt/miniconda3/lib/python3.9/lib-dynload',
 'DESTLIB': '/opt/miniconda3/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/opt/miniconda3/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/miniconda3/include '
                   '/opt/miniconda3/include '
                   '/opt/miniconda3/include/python3.9 '
                   '/opt/miniconda3/include/python3.9',
 'INCLUDEDIR': '/opt/miniconda3/include',
 'INCLUDEPY': '/opt/miniconda3/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -B /opt/miniconda3/compiler_compat -shared',
 'LDFLAGS': ''
            ''
            '-Wl,-rpath,/opt/miniconda3/lib '
            '-Wl,-rpath-link,/opt/miniconda3/lib '
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/opt/miniconda3/lib/python3.9',
 'LIBDIR': '/opt/miniconda3/lib',
 'LIBFFI_INCLUDEDIR': '/opt/miniconda3/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/miniconda3/lib/pkgconfig',
 'LIBPL': '/opt/miniconda3/lib/python3.9/config-3.9-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/miniconda3/lib/python3.9',
 ...
 'MANDIR': '/opt/miniconda3/share/man',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/miniconda3/include',
 'OPENSSL_LDFLAGS': '-L/opt/miniconda3/lib',
 ...
 'TCLTK_INCLUDES': '-I/opt/miniconda3/include',
 'TCLTK_LIBS': '-L/opt/miniconda3/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/opt/miniconda3/share/zoneinfo:/opt/miniconda3/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/opt/miniconda3/share',
