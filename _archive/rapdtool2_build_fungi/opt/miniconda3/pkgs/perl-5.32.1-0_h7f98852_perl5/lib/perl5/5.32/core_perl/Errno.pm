...
"x86_64-linux-thread-multi-4.15.0-1113-azure" or
	die "Errno architecture (x86_64-linux-thread-multi-4.15.0-1113-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
