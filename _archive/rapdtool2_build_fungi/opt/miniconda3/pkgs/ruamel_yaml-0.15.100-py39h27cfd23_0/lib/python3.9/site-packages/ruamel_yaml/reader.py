...
from ruamel_yaml.error import YAMLError, FileMark, StringMark, YAMLStreamError
from ruamel_yaml.compat import text_type, binary_type, PY3, UNICODE_SIZE
from ruamel_yaml.util import RegExp

if False:  # MYPY
    from typing import Any, Dict, Optional, List, Union, Text, Tuple, Optional  # NOQA
#    from ruamel_yaml.compat import StreamTextType  # NOQA
